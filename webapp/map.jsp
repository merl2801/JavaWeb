...
<!--==============レイアウトを制御する独自のCSSを読み込み===============-->
    ...
    <script src="https://unpkg.com/leaflet@1.6.0/dist/leaflet.js" src="https://github.com/leaflet-extras/leaflet.sprite.git"
  ...
  <header>
    ...
    <div class="hamburger-menu">
      ...
      <div class="menu-content">
        <ul>
            <li>
                <a href="#"><h2 class="basic-3">RETURN</h2></a>
            </li>
            <li>
                <a href="./login.jsp"><h2 class="basic-3">LOGIN</h2></a>
            </li>
            <li>
                <a href="#"><h2 class="basic-3">HOME</h2></a>
            </li>
        </ul>
    </div>
    <!--ここまでメニュー-->
...
<!-- 画面遷移のプログラム -->
  <body>
    ...
    <div id="view_map" style="width: 1200px; height: 800px; margin-left: 300px; margin-top: 300px"></div>
    <script type="text/javascript">
      window.onlolad=function(){}
        //緯度,経度,ズーム
        var map = L.map('view_map').setView([35.460592214807626, 139.5141777230725], 12);
      ...
      L.marker([35.460361615793204, 139.5153888071684],{icon: L.spriteIcon('red')}).addTo(map).on('click', function (e) {
            popup
              .setLatLng(e.latlng)
      ...
      L.marker([35.45948819564614, 139.51540442491412], {icon: L.spriteIcon('orange')}).addTo(map).on('click', function (e) {
            popup
              .setLatLng(e.latlng)
      ...
      L.marker([35.46026438566595, 139.50994590460482], {icon: L.spriteIcon('green')}).addTo(map).on('click', function (e) {
            popup
              .setLatLng(e.latlng)
              .setContent("ライフ希望ヶ丘店")
              .openOn(map);
